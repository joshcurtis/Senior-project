...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='pb',
  serialized_pb=_b('\n(machinetalk/protobuf/rtapi_message.proto\x12\x02pb\x1a!machinetalk/protobuf/nanopb.proto\x1a machinetalk/protobuf/value.proto\"v\n\rRTAPI_Message\x12\x10\n\x08msglevel\x18\n \x02(\x05\x12,\n\x06\x66ormat\x18\x14 \x02(\t:\x15*** uninitialized ***B\x05\x92?\x02\x08\x64\x12\x1d\n\x03\x61rg\x18\x1e \x03(\x0b\x32\t.pb.ValueB\x05\x92?\x02\x10\n:\x06\x92?\x03H\xe8\x07')
  ,
  dependencies=[machinetalk.protobuf.nanopb_pb2.DESCRIPTOR,machinetalk.protobuf.value_pb2.DESCRIPTOR,])
...
_RTAPI_MESSAGE = _descriptor.Descriptor(
  name='RTAPI_Message',
  full_name='pb.RTAPI_Message',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='msglevel', full_name='pb.RTAPI_Message.msglevel', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='format', full_name='pb.RTAPI_Message.format', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='arg', full_name='pb.RTAPI_Message.arg', index=2,
...
_RTAPI_MESSAGE.fields_by_name['arg'].message_type = machinetalk.protobuf.value_pb2._VALUE
