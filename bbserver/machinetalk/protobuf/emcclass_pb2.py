...
_PMCARTESIAN = _descriptor.Descriptor(
  name='PmCartesian',
  full_name='pb.PmCartesian',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='pb.PmCartesian.x', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y', full_name='pb.PmCartesian.y', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='z', full_name='pb.PmCartesian.z', index=2,
...
_EMCPOSE = _descriptor.Descriptor(
  name='EmcPose',
  full_name='pb.EmcPose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tran', full_name='pb.EmcPose.tran', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='a', full_name='pb.EmcPose.a', index=1,
      number=20, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='b', full_name='pb.EmcPose.b', index=2,
      number=30, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='c', full_name='pb.EmcPose.c', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='u', full_name='pb.EmcPose.u', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='v', full_name='pb.EmcPose.v', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='w', full_name='pb.EmcPose.w', index=6,
