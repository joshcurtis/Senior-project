...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5586__auto__,writer__5587__auto__,opt__5588__auto__){
return cljs.core._write(writer__5587__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__11100 = o;
(G__11100[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__4976__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__4976__auto__){
var and__4976__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__4976__auto____$1){
var and__4976__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__11108 = jsprops;
(G__11108["defaultValue"] = value);

(G__11108["onChange"] = ((function (G__11108,v,value,on_change){
return (function (p1__11106_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__11106_SHARP_);
});})(G__11108,v,value,on_change))
);
...
var vec__11113 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11113,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11113,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11113,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___11116 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___11116 == null)){
} else {
var key_11117 = temp__4429__auto___11116;
(jsprops["key"] = key_11117);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__11119 = (new reagent.impl.template.NativeWrapper());
(G__11119["name"] = c);
...
var G__11121 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__11121) : reagent.impl.template.as_element.call(null,G__11121));
} else {
...
var len__6046__auto___11127 = arguments.length;
var i__6047__auto___11128 = (0);
while(true){
if((i__6047__auto___11128 < len__6046__auto___11127)){
args__6053__auto__.push((arguments[i__6047__auto___11128]));

var G__11129 = (i__6047__auto___11128 + (1));
i__6047__auto___11128 = G__11129;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__6054__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11125){
var G__11126 = cljs.core.first(seq11125);
var seq11125__$1 = cljs.core.next(seq11125);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__11126,seq11125__$1);
});
...
break;
default:
var G__11133 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__11133;
continue;
...
var n__5891__auto___11134 = a.length;
var i_11135 = (0);
while(true){
if((i_11135 < n__5891__auto___11134)){
(a[i_11135] = reagent.impl.template.as_element((a[i_11135])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5891__auto___11137 = a.length;
var i_11138 = (0);
while(true){
if((i_11138 < n__5891__auto___11137)){
var val_11139 = (a[i_11138]);
if((cljs.core.vector_QMARK_(val_11139)) && ((reagent.impl.template.key_from_vec(val_11139) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11138] = reagent.impl.template.as_element(val_11139));

var G__11140 = (i_11138 + (1));
i_11138 = G__11140;
continue;
} else {
}
...
var ctx = {};
var vec__11142 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11142,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11142,(1),null);
...
var G__11144 = (cljs.core.count(argv) - first_child);
switch (G__11144) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__11144){
