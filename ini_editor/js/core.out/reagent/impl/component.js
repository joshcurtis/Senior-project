...
if((i < len)){
var k = (ks[i]);
var G__11024 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11025 = (i + (1));
m = G__11024;
i = G__11025;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__11029 = c;
var G__11029__$1 = (((G__11029 == null))?null:G__11029.prototype);
var G__11029__$2 = (((G__11029__$1 == null))?null:(G__11029__$1["reagentRender"]));
return G__11029__$2;
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__11033 = c;
var G__11033__$1 = (((G__11033 == null))?null:G__11033.prototype);
var G__11033__$2 = (((G__11033__$1 == null))?null:(G__11033__$1["render"]));
return G__11033__$2;
})()));
});
...
while (G__11038__i < G__11038__a.length) {G__11038__a[G__11038__i] = arguments[G__11038__i + 0]; ++G__11038__i;}
  args = new cljs.core.IndexedSeq(G__11038__a,0);
} 
...
var _STAR_current_component_STAR_11042 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11042;
}});
...
var G__11050 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__11050) {
...
return ((function (G__11050){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__11053 = reagent.impl.component.state_atom(c);
var G__11054 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__11053,G__11054) : cljs.core.reset_BANG_.call(null,G__11053,G__11054));
});
;})(G__11050))
...
var or__4988__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__11056_11058 = (c["cljsRatom"]);
var G__11056_11059__$1 = (((G__11056_11058 == null))?null:reagent.ratom.dispose_BANG_(G__11056_11058));
...
if(cljs.core.truth_((function (){var and__4976__auto__ = wrap;
...
var renders_11062 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_11063 = cljs.core.first(cljs.core.vals(renders_11062));
if((cljs.core.count(renders_11062) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_11062))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_11063)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_11063], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(cljs.core.cst$sym$ifn_QMARK_,cljs.core.cst$sym$render_DASH_fun)], 0)))].join('')));
}


var render_fun = (function (){var or__4988__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
...
var render_fun__$1 = (function (){var or__4988__auto__ = render_fun;
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__4988__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
...
var name__$1 = (function (){var G__11061 = name;
switch (G__11061) {
case "":
...
var elem = (function (){var G__11072 = (function (){var or__4988__auto__ = (function (){var G__11074 = c;
var G__11074__$1 = (((G__11074 == null))?null:(G__11074["_reactInternalInstance"]));
return G__11074__$1;
})();
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
...
var G__11072__$1 = (((G__11072 == null))?null:(G__11072["_currentElement"]));
return G__11072__$1;
})();
var name = (function (){var G__11075 = elem;
var G__11075__$1 = (((G__11075 == null))?null:(G__11075["type"]));
var G__11075__$2 = (((G__11075__$1 == null))?null:(G__11075__$1["displayName"]));
return G__11075__$2;
})();
var path = (function (){var G__11076 = elem;
var G__11076__$1 = (((G__11076 == null))?null:(G__11076["_owner"]));
var G__11076__$2 = (((G__11076__$1 == null))?null:reagent$impl$component$component_path(G__11076__$1));
var G__11076__$3 = (((G__11076__$2 == null))?null:[cljs.core.str(G__11076__$2),cljs.core.str(" > ")].join(''));
return G__11076__$3;
})();
...
var n = (function (){var or__4988__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
var G__11078 = c;
var G__11078__$1 = (((G__11078 == null))?null:G__11078.constructor);
var G__11078__$2 = (((G__11078__$1 == null))?null:reagent.impl.util.fun_name(G__11078__$1));
return G__11078__$2;
}
})();
